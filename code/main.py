...
def refineLabel(args, train_loader):
    ...
    model_clap.load_ckpt('/clap-630k-audioset-best/pytorch_model.bin') # download the default pretrained checkpoint.
...
def main():
    ...
    parser.add_argument("--audio_dir", type=str, default='data2/feats/clap/', help="audio dir")
    parser.add_argument("--video_dir", type=str, default='data2/feats/clip/', help="video dir")
    ...
    parser.add_argument("--mode", type=str, default='train_model', choices=['train_model', 'test_adda'], help="with mode to use")
    ...
    parser.add_argument("--checkpoint", type=str, default='best.pt', help="save model name")
    ...
    if args.mode == 'label_denoise':
        ...
        for epoch in range(1, args.epochs+1):
            ...
            avg_all = sum([audio_seg, visual_seg, av_seg, avg_type_seg, avg_event_seg, audio_eve, visual_eve, av_eve, avg_type_eve, avg_event_eve]) / 10
