...
def build_args():
    feat_dir = '/home/admin001/YY/Scholarship/CVPR2023-CMPAE-main/data/feats/'
    anno_dir = '/home/admin001/YY/Scholarship/CVPR2023-CMPAE-main/data/annotations/'
    ...
    parser.add_argument('--label_test', type=str, default=anno_dir + 'AVVP_test_pd.csv', help='weak test csv file')  # 'AVVP_test_pd.csv'
    ...
    parser.add_argument('--label_vit', type=str, default=anno_dir + 'AVVP_vit_pd.csv', help='weak test csv file')
    parser.add_argument('--vit_dir', type=str, default=feat_dir + 'vit/', help='video dir')
    ...
    # Model parameters
    parser.add_argument('--thres_candi', nargs='+', type=float, default=[0.35, 0.4, 0.45, 0.5, 0.55, 0.6, 0.65, 0.7])
    parser.add_argument('--select_metric', type=str, choices=['audio_seg', 'visual_seg', 'av_seg', 'avg_type_seg', 'avg_event_seg','audio_eve', 'visual_eve', 'av_eve', 'avg_type_eve', 'avg_event_eve', 'avg_all'], default='avg_all')
    ...
    parser.add_argument('--visual_weight', type=float, default=1.3)
    parser.add_argument('--video_weight', type=float, default=0.8)
    ...
    # diff nheaddiff
    parser.add_argument('--nheaddiff', type=int, default=16)
    parser.add_argument('--nheadkv', type=int, default=8)
    parser.add_argument('--depth', type=int, default=24)
    parser.add_argument('--nheadcm', type=int, default=4)

    # Action parameters
    parser.add_argument('-s', '--not_save', action='store_true', help='whether to save model')
    parser.add_argument('-w', '--without_wandb', action='store_true', default=True, help='whether to use wandb')
